...
<Cards>
    <Card 
        ...
        href="https://github.com/Pranay-Kumar-Yadav/Prompt-Engineering-Guide/blob/main/notebooks/pe-chatgpt-intro.ipynb"
    />
    <Card 
        icon={<CodeIcon />}
        title="ChatGPT with LangChain"
        href="https://github.com/Pranay-Kumar-Yadav/Prompt-Engineering-Guide/blob/main/notebooks/pe-chatgpt-langchain.ipynb"
    />
</Cards>
