...
Sie können dieses Beispiel in [diesem Notebook](https://github.com/Pranay-Kumar-Yadav/Prompt-Engineering-Guide/blob/main/notebooks/pe-chatgpt-adversarial.ipynb) ausprobieren.
