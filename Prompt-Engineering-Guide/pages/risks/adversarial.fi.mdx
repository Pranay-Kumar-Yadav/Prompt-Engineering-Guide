...
Voit kokeilla tätä esimerkkiä tässä [Notebook-ympäristössä](https://github.com/Pranay-Kumar-Yadav/Prompt-Engineering-Guide/blob/main/notebooks/pe-chatgpt-adversarial.ipynb)-ympäristössä. 
