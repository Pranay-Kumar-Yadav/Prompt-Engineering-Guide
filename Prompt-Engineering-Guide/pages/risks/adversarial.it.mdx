...
Potete provare questo esempio in [questo notebook](https://github.com/Pranay-Kumar-Yadav/Prompt-Engineering-Guide/blob/main/notebooks/pe-chatgpt-adversarial.ipynb). 
