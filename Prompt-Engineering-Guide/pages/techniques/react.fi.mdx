...
Löydät tämän koodin sisältävän Notebook-ympäristön täältä: https://github.com/Pranay-Kumar-Yadav/Prompt-Engineering-Guide/blob/main/notebooks/react.ipynb
